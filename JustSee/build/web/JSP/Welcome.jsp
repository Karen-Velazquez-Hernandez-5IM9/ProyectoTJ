<%-- 
    Document   : Welcome
    Created on : 6/10/2018, 01:05:42 PM
    Author     : Kagigi
--%>
        ...
        <div id="cero">
            ...
            <div id="dos">
                ...
                <header>
                    ...
                    <nav class="menu">
                        <ul>
                            <li><a id="pos" href="/JustSee/JSP/RegPersona.jsp">Registrar personas</a></li>
                            <li><a id="pes" href="/JustSee/JSP/RegLugar.jsp">Registrar lugares</a></li>
                            <li><a id="pas" href="/JustSee/JSP/Rol.jsp">Asignar roles</a></li>
                        </ul>
                    </nav>
                </header>
            </div>
